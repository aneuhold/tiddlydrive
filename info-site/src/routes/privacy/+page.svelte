...
<main class="policy">
  ...
  <p>
    ...
    contacted are Google APIs needed to open and save the file you explicitly select, plus optional third‑party
    resources (fonts / icons) shown in the page head.
  </p>
  <h2>Data We Access</h2>
  <ul>
    <li>
      <strong>Selected File Content:</strong> The HTML of the TiddlyWiki file you open using Google Drive’s
      “Open with” flow.
    </li>
    <li>
  ...
  <h2>Security</h2>
  <p>
    All requests occur over HTTPS. Save operations use conditional headers (ETag / modified time) to
    help prevent accidental overwrites. No secret keys are embedded client‑side beyond the public
    OAuth Client ID.
  </p>
  <h2>Data Deletion</h2>
  <p>
  ...
  <p class="back-link">
    <a data-sveltekit-preload-data="hover" href="/">← Back to home</a>
  </p>
</main>
